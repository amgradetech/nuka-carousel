...
var Carousel = _react2['default'].createClass({
  ...
  _setDimensions: function _setDimensions(props, firstSlideOffsetHeight) {
    ...
    if (typeof firstSlideOffsetHeight !== 'undefined') {
      slideHeight = this.props.vertical ? firstSlideOffsetHeight * props.slidesToShow : firstSlideOffsetHeight;
    } else {
      slideHeight = 100;
    }
  ...
  setDimensions: function setDimensions(props) {
    ...
    var firstSlideImages = undefined;
    ...
    if (firstSlideImages.length) {
      (function () {
        var imagesLoadedProgress = 0;

        var imageLoaded = function imageLoaded(imgNode) {
        ...
        Array.prototype.slice.apply(firstSlideImages).forEach(function (imgNode) {
