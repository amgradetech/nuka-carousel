...
var Carousel = _react2['default'].createClass({
  ...
  getDotIndexes: function getDotIndexes(count, inc) {
    var arr = [];
  ...
  render: function render() {
    ...
    var dotIndexes = this.getDotIndexes(self.state.slideCount, self.state.slidesToScroll);

    return _react2['default'].createElement(
      'div',
      { className: ['slider', this.props.className || ''].join(' '), ref: 'slider',
      ...
      _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'button',
          {
            className: (0, _classnames2['default'])("slider-controls__prev", {
              'disabled': self.state.currentSlide === 0 && !self.props.wrapAround
            }),
        ...
        _react2['default'].createElement(
          'button',
          {
            className: (0, _classnames2['default'])("slider-controls__next", {
              'disabled': self.state.currentSlide + self.state.slidesToScroll >= self.state.slideCount && !self.props.wrapAround
            }),
        ...
        _react2['default'].createElement(
          'ul',
          { className: 'slider-controls__dots' },
          dotIndexes.map(function (index) {
            return _react2['default'].createElement(
              'li',
              { key: index,
                className: (0, _classnames2['default'])("slider-controls__dot", { 'active': self.state.currentSlide === index }) },
              _react2['default'].createElement(
                'button',
                {
                  onClick: self.goToSlide.bind(null, index) },
                '•'
              )
            );
          })
...
/*currentSlide={self.state.currentSlide}*/ /*slideCount={self.state.slideCount}*/ /*frameWidth={self.state.frameWidth}*/ /*slideWidth={self.state.slideWidth}*/ /*slidesToScroll={self.state.slidesToScroll}*/ /*cellSpacing={self.props.cellSpacing}*/ /*slidesToShow={self.props.slidesToShow}*/ /*wrapAround={self.props.wrapAround}*/ /*nextSlide={self.nextSlide}*/ /*previousSlide={self.previousSlide}*/ /*goToSlide={self.goToSlide}*/